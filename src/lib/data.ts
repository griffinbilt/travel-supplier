...
export const reservations: Reservation[] = [
  { id: 1, guest: "Aisha Moreno", source: "Expedia", checkIn: "Mar 20", checkOut: "Mar 24", status: "Confirmed", roomNo: "#101", commission: "$180.00", total: "$1,200.00", commissionable: true },
  ...
  { id: 5, guest: "Leon Vasquez", source: "Bilt rate", checkIn: "Mar 20", checkOut: "Mar 28", status: "Confirmed", roomNo: "#505", commission: "$150.00", total: "$1,010.00", commissionable: true },
...
export const checkingInToday: Reservation[] = [
  { id: 11, guest: "Priya Sharma", source: "Direct", checkIn: "Mar 26", checkOut: "Mar 30", status: "Confirmed", roomNo: "#108", commission: "$170.00", total: "$1,150.00", commissionable: true },
  ...
  { id: 14, guest: "James O'Brien", source: "Bilt rate", checkIn: "Mar 26", checkOut: "Mar 28", status: "Confirmed", roomNo: "#422", commission: "$120.00", total: "$850.00", commissionable: true },
...
export const checkingOutToday: Reservation[] = [
  { id: 16, guest: "Elena Petrov", source: "Direct", checkIn: "Mar 22", checkOut: "Mar 26", status: "Checked in", roomNo: "#112", commission: "$160.00", total: "$1,080.00", commissionable: true },
...
export const pastReservations: Reservation[] = [
  { id: 101, guest: "Hannah Mitchell", source: "Direct", checkIn: "Feb 10", checkOut: "Feb 14", status: "Completed", roomNo: "#101", commission: "$175.00", total: "$1,180.00", commissionable: true },
  ...
  { id: 105, guest: "Mei Chen", source: "Flexible", checkIn: "Feb 20", checkOut: "Feb 25", status: "Completed", roomNo: "#512", commission: "$185.00", total: "$1,250.00", commissionable: true },
  ...
  { id: 109, guest: "Aiko Yamamoto", source: "HAFH", checkIn: "Mar 3", checkOut: "Mar 8", status: "Completed", roomNo: "#314", commission: "$195.00", total: "$1,300.00", commissionable: true },
