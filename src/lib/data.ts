...
export const reservations: Reservation[] = [
  ...
  { id: 3, guest: "Diego Kim", source: "GDS", rate: "HAFH", checkIn: "Mar 20", checkOut: "Mar 25", status: "Checked in", roomNo: "#303", commission: "$155.00", total: "$1,035.00", commissionable: true, credit: { amount: 50, applied: true } },
  ...
  { id: 5, guest: "Leon Vasquez", source: "GDS", rate: "Bilt", checkIn: "Mar 20", checkOut: "Mar 28", status: "Confirmed", roomNo: "#505", commission: "$150.00", total: "$1,010.00", commissionable: true, vip: true, credit: { amount: 50, applied: false } },
  ...
  { id: 7, guest: "Malik Johansson", source: "GDS", rate: "Non-refundable", checkIn: "Mar 26", checkOut: "Mar 30", status: "Checked in", roomNo: "#707", commission: "$160.00", total: "$1,063.00", commissionable: true },
  ...
  { id: 9, guest: "William Okafor", source: "GDS", rate: "Non-refundable", checkIn: "Mar 28", checkOut: "Apr 1", status: "Confirmed", roomNo: "#909", commission: "$180.00", total: "$1,205.00", commissionable: true },
  ...
  { id: 11, guest: "Camille Rousseau", source: "GDS", rate: "Virtuoso", checkIn: "Mar 21", checkOut: "Mar 25", status: "Confirmed", roomNo: "#111", commission: "$195.00", total: "$1,310.00", commissionable: true, vip: true, credit: { amount: 100, applied: false } },
  ...
  { id: 13, guest: "Yara El-Masri", source: "GDS", rate: "HAFH", checkIn: "Mar 21", checkOut: "Mar 24", status: "Pending", roomNo: "#213", commission: "$140.00", total: "$960.00", commissionable: true, credit: { amount: 50, applied: false } },
  { id: 14, guest: "Tomás Herrera", source: "GDS", rate: "Bilt", checkIn: "Mar 22", checkOut: "Mar 26", status: "Confirmed", roomNo: "#214", commission: "$165.00", total: "$1,100.00", commissionable: true, credit: { amount: 100, applied: false } },
  ...
  { id: 16, guest: "Kofi Mensah", source: "GDS", rate: "Non-refundable", checkIn: "Mar 22", checkOut: "Mar 25", status: "Checked in", roomNo: "#316", commission: "$130.00", total: "$890.00", commissionable: true },
  ...
  { id: 19, guest: "Lucia Ferrara", source: "GDS", rate: "HAFH", checkIn: "Mar 23", checkOut: "Mar 29", status: "Checked in", roomNo: "#519", commission: "$185.00", total: "$1,260.00", commissionable: true, credit: { amount: 100, applied: true } },
  { id: 20, guest: "Chen Wei", source: "GDS", rate: "Bilt", checkIn: "Mar 24", checkOut: "Mar 28", status: "Confirmed", roomNo: "#520", commission: "$160.00", total: "$1,080.00", commissionable: true, credit: { amount: 50, applied: false } },
  ...
  { id: 22, guest: "Emmanuel Obi", source: "GDS", rate: "Non-refundable", checkIn: "Mar 24", checkOut: "Mar 27", status: "Cancelled", roomNo: "#622", commission: "$0.00", total: "$920.00", commissionable: false },
  ...
  { id: 25, guest: "Amina Diallo", source: "GDS", rate: "HAFH", checkIn: "Mar 25", checkOut: "Mar 28", status: "Pending", roomNo: "#825", commission: "$135.00", total: "$915.00", commissionable: true, credit: { amount: 50, applied: false } },
  { id: 26, guest: "Oliver Schreiber", source: "GDS", rate: "Bilt", checkIn: "Mar 26", checkOut: "Mar 31", status: "Confirmed", roomNo: "#826", commission: "$200.00", total: "$1,350.00", commissionable: true, credit: { amount: 100, applied: false } },
  ...
  { id: 28, guest: "Kenji Watanabe", source: "GDS", rate: "Non-refundable", checkIn: "Mar 26", checkOut: "Mar 29", status: "Cancelled", roomNo: "#928", commission: "$0.00", total: "$870.00", commissionable: false },
  ...
  { id: 31, guest: "Fatou Sow", source: "GDS", rate: "Virtuoso", checkIn: "Mar 27", checkOut: "Apr 2", status: "Checked in", roomNo: "#1031", commission: "$195.00", total: "$1,320.00", commissionable: true, credit: { amount: 100, applied: true } },
  { id: 32, guest: "Viktor Petrov", source: "GDS", rate: "Bilt", checkIn: "Mar 28", checkOut: "Apr 1", status: "Confirmed", roomNo: "#102", commission: "$170.00", total: "$1,150.00", commissionable: true, credit: { amount: 100, applied: false } },
  ...
  { id: 34, guest: "Kwame Adjei", source: "GDS", rate: "Non-refundable", checkIn: "Mar 28", checkOut: "Mar 31", status: "Cancelled", roomNo: "#304", commission: "$0.00", total: "$945.00", commissionable: false },
  ...
  { id: 37, guest: "Lina Farouk", source: "GDS", rate: "Virtuoso", checkIn: "Mar 29", checkOut: "Apr 1", status: "Pending", roomNo: "#607", commission: "$145.00", total: "$980.00", commissionable: true, credit: { amount: 50, applied: false } },
  { id: 38, guest: "Matteo Conti", source: "GDS", rate: "Bilt", checkIn: "Mar 30", checkOut: "Apr 3", status: "Confirmed", roomNo: "#708", commission: "$175.00", total: "$1,185.00", commissionable: true, credit: { amount: 100, applied: false } },
  ...
  { id: 40, guest: "Thierry Bouchard", source: "GDS", rate: "Non-refundable", checkIn: "Mar 30", checkOut: "Apr 2", status: "Cancelled", roomNo: "#910", commission: "$0.00", total: "$910.00", commissionable: false },
  ...
  { id: 43, guest: "Hassan Sharif", source: "GDS", rate: "HAFH", checkIn: "Mar 31", checkOut: "Apr 3", status: "Checked in", roomNo: "#214", commission: "$150.00", total: "$1,020.00", commissionable: true, credit: { amount: 50, applied: true } },
  { id: 44, guest: "Sienna Walsh", source: "GDS", rate: "Virtuoso", checkIn: "Apr 1", checkOut: "Apr 5", status: "Confirmed", roomNo: "#315", commission: "$180.00", total: "$1,210.00", commissionable: true, vip: true, credit: { amount: 100, applied: false } },
  ...
  { id: 46, guest: "Zara Okonkwo", source: "GDS", rate: "Non-refundable", checkIn: "Apr 1", checkOut: "Apr 4", status: "Cancelled", roomNo: "#517", commission: "$0.00", total: "$935.00", commissionable: false },
  ...
  { id: 49, guest: "Adama Traoré", source: "GDS", rate: "HAFH", checkIn: "Apr 2", checkOut: "Apr 5", status: "Pending", roomNo: "#820", commission: "$140.00", total: "$950.00", commissionable: true, credit: { amount: 50, applied: false } },
  { id: 50, guest: "Isla McGregor", source: "GDS", rate: "Bilt", checkIn: "Apr 3", checkOut: "Apr 7", status: "Confirmed", roomNo: "#921", commission: "$185.00", total: "$1,255.00", commissionable: true, vip: true, credit: { amount: 100, applied: false } },
  ...
  { id: 52, guest: "Celine Dubois", source: "GDS", rate: "Non-refundable", checkIn: "Apr 3", checkOut: "Apr 6", status: "Cancelled", roomNo: "#123", commission: "$0.00", total: "$895.00", commissionable: false },
  ...
  { id: 55, guest: "Ousmane Diop", source: "GDS", rate: "HAFH", checkIn: "Apr 4", checkOut: "Apr 7", status: "Checked in", roomNo: "#426", commission: "$145.00", total: "$985.00", commissionable: true, credit: { amount: 50, applied: false } },
  { id: 56, guest: "Astrid Bergman", source: "GDS", rate: "Bilt", checkIn: "Apr 5", checkOut: "Apr 9", status: "Confirmed", roomNo: "#527", commission: "$190.00", total: "$1,290.00", commissionable: true, credit: { amount: 100, applied: false } },
  ...
  { id: 58, guest: "Priya Kapoor", source: "GDS", rate: "Non-refundable", checkIn: "Apr 5", checkOut: "Apr 8", status: "Cancelled", roomNo: "#729", commission: "$0.00", total: "$920.00", commissionable: false },
...
export const checkingInToday: Reservation[] = [
  ...
  { id: 13, guest: "Fatima Al-Rashid", source: "GDS", rate: "HAFH", checkIn: "Mar 26", checkOut: "Apr 1", status: "Confirmed", roomNo: "#310", commission: "$190.00", total: "$1,320.00", commissionable: false, credit: { amount: 100, applied: false } },
  { id: 14, guest: "James O'Brien", source: "GDS", rate: "Bilt", checkIn: "Mar 26", checkOut: "Mar 28", status: "Confirmed", roomNo: "#422", commission: "$120.00", total: "$850.00", commissionable: true, vip: true, credit: { amount: 50, applied: false } },
...
export const checkingOutToday: Reservation[] = [
  ...
  { id: 18, guest: "Lena Johansson", source: "GDS", rate: "Non-refundable", checkIn: "Mar 24", checkOut: "Mar 26", status: "Checked in", roomNo: "#305", commission: "$0.00", total: "$780.00", commissionable: false },
];
...
export const pastReservations: Reservation[] = [
  ...
  { id: 103, guest: "Sofia Andersson", source: "GDS", rate: "HAFH", checkIn: "Feb 15", checkOut: "Feb 20", status: "Completed", roomNo: "#307", commission: "$200.00", total: "$1,350.00", commissionable: true },
  { id: 104, guest: "Omar Hassan", source: "GDS", rate: "Bilt", checkIn: "Feb 18", checkOut: "Feb 22", status: "Completed", roomNo: "#410", commission: "$0.00", total: "$990.00", commissionable: false },
  ...
  { id: 106, guest: "Thomas Weber", source: "GDS", rate: "Non-refundable", checkIn: "Feb 22", checkOut: "Feb 26", status: "Completed", roomNo: "#605", commission: "$0.00", total: "$1,020.00", commissionable: false },
  ...
  { id: 109, guest: "Aiko Yamamoto", source: "GDS", rate: "HAFH", checkIn: "Mar 3", checkOut: "Mar 8", status: "Completed", roomNo: "#314", commission: "$195.00", total: "$1,300.00", commissionable: true, vip: true },
  ...
  { id: 111, guest: "Nina Ivanova", source: "GDS", rate: "Bilt", checkIn: "Mar 8", checkOut: "Mar 12", status: "Cancelled", roomNo: "#509", commission: "$140.00", total: "$960.00", commissionable: true },
  { id: 112, guest: "Kwame Asante", source: "GDS", rate: "Non-refundable", checkIn: "Mar 10", checkOut: "Mar 14", status: "Completed", roomNo: "#611", commission: "$0.00", total: "$1,100.00", commissionable: false },
  ...
  { id: 116, guest: "Joaquin Navarro", source: "GDS", rate: "Bilt", checkIn: "Jan 5", checkOut: "Jan 9", status: "Completed", roomNo: "#103", commission: "$165.00", total: "$1,110.00", commissionable: true },
  { id: 117, guest: "Fatima Benali", source: "GDS", rate: "Non-refundable", checkIn: "Jan 7", checkOut: "Jan 12", status: "Completed", roomNo: "#205", commission: "$0.00", total: "$1,320.00", commissionable: false, vip: true },
  ...
  { id: 120, guest: "Patrick O'Connell", source: "GDS", rate: "HAFH", checkIn: "Jan 15", checkOut: "Jan 19", status: "Cancelled", roomNo: "#510", commission: "$0.00", total: "$1,060.00", commissionable: false },
  ...
  { id: 122, guest: "Youssef El-Amin", source: "GDS", rate: "Bilt", checkIn: "Jan 20", checkOut: "Jan 24", status: "Completed", roomNo: "#713", commission: "$155.00", total: "$1,050.00", commissionable: true, vip: true },
  { id: 123, guest: "Monika Szabo", source: "GDS", rate: "Non-refundable", checkIn: "Jan 22", checkOut: "Jan 26", status: "Completed", roomNo: "#814", commission: "$0.00", total: "$980.00", commissionable: false },
  ...
  { id: 126, guest: "Anders Holm", source: "GDS", rate: "HAFH", checkIn: "Feb 1", checkOut: "Feb 5", status: "Completed", roomNo: "#117", commission: "$160.00", total: "$1,085.00", commissionable: true },
  ...
  { id: 128, guest: "Emeka Nwosu", source: "GDS", rate: "Bilt", checkIn: "Feb 5", checkOut: "Feb 9", status: "Completed", roomNo: "#319", commission: "$145.00", total: "$985.00", commissionable: true },
  { id: 129, guest: "Katarina Novak", source: "GDS", rate: "Non-refundable", checkIn: "Feb 7", checkOut: "Feb 12", status: "Completed", roomNo: "#420", commission: "$0.00", total: "$1,310.00", commissionable: false, vip: true },
  ...
  { id: 132, guest: "Henrik Larsen", source: "GDS", rate: "HAFH", checkIn: "Jan 6", checkOut: "Jan 11", status: "Completed", roomNo: "#723", commission: "$190.00", total: "$1,290.00", commissionable: true },
  ...
  { id: 134, guest: "Luca Fontana", source: "GDS", rate: "Bilt", checkIn: "Jan 11", checkOut: "Jan 16", status: "Cancelled", roomNo: "#925", commission: "$0.00", total: "$1,350.00", commissionable: false },
  { id: 135, guest: "Adeline Fournier", source: "GDS", rate: "Non-refundable", checkIn: "Jan 14", checkOut: "Jan 18", status: "Completed", roomNo: "#1026", commission: "$0.00", total: "$960.00", commissionable: false, vip: true },
];
