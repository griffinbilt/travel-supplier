    ...
    <div className="flex h-full">
      ...
      <main className="flex-1 overflow-y-auto bg-white">
        ...
        <div className="max-w-[680px] mx-auto px-6 py-8">
          ...
          <div className="border border-[#e5e5e5] rounded-xl px-4 py-3 mb-8 flex items-center gap-3">
          ...
          <Field label="Last name" value="Doe" className="mb-8" />
          ...
          <Field label="Email" value="jane.doe@example.com" className="mb-8" />
          ...
          {/* Value Add Tax */}
          <h3 className="text-[16px] font-semibold mb-4 mt-8">Value Add Tax</h3>
          <Field label="Amount" value="$4,000.00" className="mb-2" />
          <p className="text-[12px] text-[#a3a3a3] mb-8">100% of VAT will be passed on to the agency.</p>
          ...
          {/* Warning */}
          <div className="border border-[#fbbf24] bg-[#fffbeb] rounded-xl px-4 py-3 mb-8 flex items-center gap-2 text-[13px] text-[#92400e]">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Submit */}
          <button className="w-full bg-black text-white rounded-xl py-3.5 text-[14px] font-semibold hover:bg-[#262626] transition-colors mb-8">
            Create reservation
          </button>
        </div>
      </main>
